...
class __TwigTemplate_1d860133c011784d4708762e2f8b38f08591ab758680e7417e0be980e71dce53 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div id=\"content\" class=\"container\">
                ...
                <div id=\"sidebar-shortcuts\">
                    <div class=\"shortcuts\">
                        <a href=\"#\" id=\"sidebarShortcutsMenu\" class=\"visible-small\">
                            <span class=\"icon\">";
        // line 101
        echo twig_include($this->env, $context, "@WebProfiler/Icon/_menu.svg");
        echo "</span>
                        </a>
        ...
        if (array_key_exists("templates", $context)) {
            ...
            foreach ($context['_seq'] as $context["name"] => $context["template"]) {
                ...
                ob_start();
                // line 119
                if (                $this->loadTemplate($context["template"], "@WebProfiler/Profiler/layout.html.twig", 119)->hasBlock("_menu", $context)) {
                    // line 120
                    ...
                    // line 121
                    $this->loadTemplate($context["template"], "@WebProfiler/Profiler/layout.html.twig", 121)->displayBlock("_menu", $context);
                    $context = $__internal_f607aeef2c31a95a7bf963452dff024ffaeb6aafbe4603f9ca3bec57be8633f4;
                }
                $context["_menu"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
                // line 125
                echo "                            ";
                if ( !twig_test_empty((isset($context["_menu"]) || array_key_exists("_menu", $context) ? $context["_menu"] : (function () { throw new RuntimeError('Variable "_menu" does not exist.', 125, $this->source); })()))) {
                    // line 126
                    echo "                                <li class=\"";
                    ...
                    echo "\">";
                    echo (isset($context["_menu"]) || array_key_exists("_menu", $context) ? $context["_menu"] : (function () { throw new RuntimeError('Variable "_menu" does not exist.', 127, $this->source); })());
                    echo "</a>
                                </li>
                            ";
                }
        ...
        <div id=\"main\">
            <div id=\"sidebar\">
                <div id=\"sidebar-shortcuts\">
                    <div class=\"shortcuts\">
                        <a href=\"#\" id=\"sidebarShortcutsMenu\" class=\"visible-small\">
                            <span class=\"icon\">{{ include('@WebProfiler/Icon/_menu.svg') }}</span>
                        </a>
                ...
                {% if templates is defined %}
                    <ul id=\"_menu-profiler\">
                        {% for name, template in templates %}
                            {% set _menu -%}
                                {%- if block('_menu', template) is defined -%}
                                    {% with { collector: profile.getcollector(name), profiler_markup_version: profiler_markup_version } %}
                                        {{- block('_menu', template) -}}
                                    {% endwith %}
                                {%- endif -%}
                            {%- endset %}
                            {% if _menu is not empty %}
                                <li class=\"{{ name }} {{ name == panel ? 'selected' }}\">
                                    <a href=\"{{ path('_profiler', { token: token, panel: name }) }}\">{{ _menu|raw }}</a>
                                </li>
                            {% endif %}
                        {% endfor %}
                    </ul>
...
{% endblock %}
", "@WebProfiler/Profiler/layout.html.twig", "C:\\Users\\Даниил Кирпа\\Desktop\\lasthuita\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\layout.html.twig");
    }
}
