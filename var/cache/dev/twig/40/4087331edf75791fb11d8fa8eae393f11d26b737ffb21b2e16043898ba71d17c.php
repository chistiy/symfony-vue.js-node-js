...
class __TwigTemplate_4c2d1d88cbdb945e941500e9d72dd9194bd28c66f3ea7915d4c7c99edada6577 extends Template
{
    private $source;
    private $macros = [];
...
#_menu-profiler li a:hover {
    text-decoration: none;
}
#_menu-profiler li a .label {
    background: transparent;
    color: #EEE;
    display: block;
...
#_menu-profiler li a .label .icon {
    display: block;
    position: absolute;
    left: 0;
    top: 8px;
...
#_menu-profiler .label .icon img,
#_menu-profiler .label .icon svg {
    height: 24px;
    max-width: 24px;
}
#_menu-profiler li a .label .icon svg path,
#_menu-profiler li a .label .icon svg .sf-svg-path {
    fill: #DDD;
}
#_menu-profiler li a .label strong {
    font-size: 16px;
    font-weight: normal;
}
#_menu-profiler li a .label.disabled {
    opacity: .25;
}
#_menu-profiler li a:hover .label.disabled,
#_menu-profiler li.selected a .label.disabled {
    opacity: 1;
}

#_menu-profiler li.selected a,
#_menu-profiler:hover li.selected a:hover,
#_menu-profiler li a:hover {
    background: #666;
    border: solid #555;
    border-width: 2px 0;
}
#_menu-profiler li.selected a .label,
#_menu-profiler li a:hover .label {
    color: #FFF;
}
#_menu-profiler li.selected a .icon svg path,
#_menu-profiler li.selected a .icon svg .sf-svg-path,
#_menu-profiler li a:hover .icon svg path,
#_menu-profiler li a:hover .icon svg .sf-svg-path {
    fill: #fff;
}

#_menu-profiler li a .count {
...
#_menu-profiler li a span.count span {
    font-size: 12px;

}
#_menu-profiler li a span.count span + span::before {
    content: \" / \";
    color: #AAA;
}

#_menu-profiler .label-status-warning .count {
    background: var(--color-warning);
}
#_menu-profiler .label-status-error .count {
...
", "@WebProfiler/Profiler/profiler.css.twig", "C:\\Users\\Даниил Кирпа\\Desktop\\lasthuita\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\profiler.css.twig");
    }
}
